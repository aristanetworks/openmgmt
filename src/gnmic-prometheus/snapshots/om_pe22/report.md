...
--------------- -------------------- ---------- ------------- --------- -------
Management0     172.144.100.7/24     up         up              1500
```
## show lldp neighbors

```
Last table change time   : 0:16:29 ago
...
---------- ------------------------ ---------------------- ---
Et1           om-spine1                Ethernet4           120
Et2           om-spine2                Ethernet4           120
...
! device: om-pe22 (cEOSLab, EOS-4.32.2F-38195967.4322F (engineering build))
!
no aaa root
!
username admin privilege 15 role network-admin secret sha512 $6$GFPAn8A5azCMViSZ$TqjBj.bYBkKXZAawL9smLfNsoHWuVkucPWJLMis9Rvl01bxRWEYTDXdDpty9aB7ZB454GO1EALeEIWWDTti201
!
...
interface Management0
   ...
   ipv6 address 2001:172:144:100::d/80
!
no ip routing
...
Arista cEOSLab
Hardware version: 
Serial number: OMLEAF4
Hardware MAC address: 001c.aaad.aa22
System MAC address: 001c.aaad.aa22
