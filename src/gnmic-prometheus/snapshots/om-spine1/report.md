...
--------------- -------------------- ---------- ------------- --------- -------
Management0     172.144.100.2/24     up         up              1500
```
## show lldp neighbors

```
Last table change time   : 0:03:31 ago
...
---------- ------------------------ ---------------------- ---
Et1           om-pe11                  Ethernet1           120
Et2           om-pe12                  Ethernet1           120
Et3           om-pe21                  Ethernet1           120
Et4           om-pe22                  Ethernet1           120
...
! device: om-spine1 (cEOSLab, EOS-4.32.2F-38195967.4322F (engineering build))
!
no aaa root
!
username admin privilege 15 role network-admin secret sha512 $6$.I3kdVGOvql07yb7$PmJZFxQi45rWCMaH3Bw99q7MEb3urpL/zwWF.Mbxvmx/VyHgk/U2k0NRPxTTMLU3r..PtFxG2UlAJxwpP.dtz.
!
...
interface Management0
   ...
   ipv6 address 2001:172:144:100::6/80
!
no ip routing
...
Arista cEOSLab
Hardware version: 
Serial number: OMSPINE1
Hardware MAC address: 001c.aaae.aaa1
System MAC address: 001c.aaae.aaa1
