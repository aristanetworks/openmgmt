...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 172.144.100.5/24 | 172.144.100.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_OM_SPINE1_Ethernet2 | routed | - | 172.31.255.5/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_OM_SPINE2_Ethernet2 | routed | - | 172.31.255.7/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_OM_SPINE1_Ethernet2
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_OM_SPINE2_Ethernet2
   no shutdown
   mtu 9214
   no switchport
...
router bgp 65102
   ...
   neighbor 172.31.255.4 description om_spine1_Ethernet2
   neighbor 172.31.255.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.6 remote-as 65001
   neighbor 172.31.255.6 description om_spine2_Ethernet2
