...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_OM_SPINE1_Ethernet3 | routed | - | 172.31.255.9/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_OM_SPINE2_Ethernet3 | routed | - | 172.31.255.11/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_OM_SPINE1_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_OM_SPINE2_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
router bgp 65103
   ...
   neighbor 172.31.255.8 description om_spine1_Ethernet3
   neighbor 172.31.255.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.10 remote-as 65001
   neighbor 172.31.255.10 description om_spine2_Ethernet3
