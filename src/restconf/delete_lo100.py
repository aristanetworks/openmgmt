...
print("get int lo100")
result_get = requests.get(api_call, auth=HTTPBasicAuth(USER, PASS), headers=headers, verify=False)
...
if result_get.status_code == 200:
    ...
    result_delete = requests.delete(api_call, auth=HTTPBasicAuth(USER, PASS), headers=headers, verify=False)
